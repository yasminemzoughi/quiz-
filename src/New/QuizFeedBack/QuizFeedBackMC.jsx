...
// Multiple Choice === MC //
const QuizFeedBackMC = ({ questions, selectedAns }) => {
      ...
      <div className="quiz-feed-card">
        {questions?.map((item, key) => {
          ...
          const isAnswerCorrect =
            JSON.stringify(selectedAnswer?.slice().sort()) ===
            JSON.stringify(item.answer?.slice().sort());
              ...
              <div className="quiz-checking-wrap">
                {isAnswerCorrect && selectedAns.length ? (
                  <span className="quiz-feed-answer-text quiz-true">
                    ...
                    {selectedAnswer?.slice().sort().toString()}
                    {console.table(item.answer)}
                  </span>
                ) : (
                  <div className="quiz-check-wrong">
                    {selectedAns.length ? (
                      <>
                        ...
                        <span className="quiz-feed-answer-text quiz-true">
                          <CheckCircle className="quiz-true" />
                          {item.answer?.slice().sort().toString()}
                        </span>
                      </>
                    ) : (
                      <span className="quiz-feed-answer-text quiz-true">
